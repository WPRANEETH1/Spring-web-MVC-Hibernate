            ...
            <div class="row">
                <div class="col-md-12">                    
                    ...
                    <div class="col-md-9" style="text-align: left">
                        ...
                        <h4 style="color: black">There are currently XX experts.</h4>
                        <h4 style="color: black">There are currently XX users.</h4>
                        <input type="button" value="View Gallery" class="btn btn-success"/>
                    </div>
                </div>
                <span style="text-align: left;padding-bottom: 0px;">
                    <h3 style="margin-left: 7%">Member Since : XX XX</h3>
                </span>                
            </div>
        </div>
    </section>
